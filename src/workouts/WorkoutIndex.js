...
const WorkoutIndex = (props) =>{
    ...
    //! this fetch does NOT work because the path requires a user id. I don't know how to get this in and it is not included in the module. I could build a path that fetches all logs, but that isn't what is being asked (I don't think)
    const fetchWorkouts = () =>{
